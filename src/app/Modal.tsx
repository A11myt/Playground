      ...
      <div className={`flex flex-col h-full  rounded-md w-full overflow-auto p-10 `}>
        <div className='w-full flex justify-between items-baseline '>
          ...
          <div className="flex w-full justify-end ">
            <button className="w-6 h-6 border-2 border-black bg-futureOrange-50 rotate-45 text-snow-50 dark:text-night-300 flex justify-center items-center rounded-md"
              onClick={() => onClose()}><span className="px-[-1px] text-4xl">+
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="p-4 flex w-full h-24 ">
          <div className="rounded-md p-auto w-full flex items-center text-gray-800/90 font-bold backdrop-blur-md bg-black/10 justify-between">
            <div className="grid grid-flow-col h-full items-center">
              <span className="align-center border-gray-800/90 border-r px-3 font-black text-2xl">{date.year}</span>
